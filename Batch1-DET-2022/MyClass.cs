...
namespace Batch1_DET_2022
{
    internal class MyClass
    {
        ...
        public static void Main()
        {
            try
            {
                Emp22 m = new Manager(4671, "Karthika", new DateTime(2005, 5, 10), "techtrng", 10);  //default constructor
                                                                                                   // Console.WriteLine(m.Print());

                Emp22 m1 = new Manager(2345, "Jeeva", new DateTime(2010, 1, 14), "PEMS", 450);
                // Console.WriteLine(m1.Print());  //base class ref can point to derived object

                Emp22 e1 = new Emp22(1, "Jiyana", new DateTime (2020, 1, 5));
                ...
                Emp22 e2 = new(id, name, doj);


                List<Emp22> list = new List<Emp22>();
                list.Add(m);
                list.Add(m1);
                list.Add(e1);
                foreach (Emp22 x in list)
